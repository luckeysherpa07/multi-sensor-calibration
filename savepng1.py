...
while True:
    num_frames_to_save = int(input("Enter how many FRAME PNGs you want to save: "))
    num_events_to_save = int(input("Enter how many Event PNGs you want to save: "))

    print(f"{num_frames_to_save} for FRAME PNGs and {num_events_to_save} for EVENT PNGs.")
